...
public class UserRoleServiceTests : IDisposable
{
    ...
    public UserRoleServiceTests()
    {
        DbContextOptions<KyberKlassDbContext> options = new DbContextOptionsBuilder<KyberKlassDbContext>()
            .UseInMemoryDatabase("KyberKlassTestDb")
            .Options;
...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        _sut = new UserRoleService(_dbContextMock, _userManagerMock.Object, _roleManagerMock.Object,
        userServiceMock.Object, schoolServiceMock.Object, guardianServiceMock.Object);
    }
    ...
    public async Task GetRoleNameByIdAsyncReturnsRoleName()
    {
        ...
        _roleManagerMock.Setup(expression: m => m.FindByIdAsync(roleId))
            .ReturnsAsync(role);
    ...
    public async Task GetRoleNameByIdAsync_ReturnsNullForInvalidRoleId()
    {
        ...
        _roleManagerMock.Setup(expression: m => m.FindByIdAsync(invalidRoleId))
    ...
    public async Task UpdateRoleAsync_UserNotFoundReturnsFalse()
    {
        ...
        _userManagerMock.Setup(expression: m => m.FindByIdAsync(invalidUserId.ToString()))
    ...
    public async Task UpdateRoleAsync_RoleNotFoundReturnsFalse()
    {
        ...
        _userManagerMock.Setup(expression: m => m.FindByIdAsync(userId.ToString()))
            .ReturnsAsync(user);

        _roleManagerMock.Setup(expression: m => m.FindByIdAsync(invalidRoleId.ToString()))
            .ReturnsAsync((IdentityRole<Guid>?)null);
    ...
    public async Task GetForUpdateRoleAsync_UserNotFoundReturnsNull()
    {
        ...
        // Act
        UserUpdateRoleViewModel? result = await _sut.GetForUpdateRoleAsync(userId);
